...
1. [Файлы, пакеты](#1-Файлы--пакеты)
2. [Отступы, длина строки, переносы строк](#2-Отступы--длина-строки--переносы-строк)
3. [Расположение блоков, операторов, пробелы, скобки](#3-Расположение-блоков--операторов--пробелы--скобки)
4. [Имена методов, переменных](#4-Имена-методов--переменных)
5. [Структурирование кода](#5-Структурирование-кода)
6. [Комментарии/Javadoc](#6-Комментарии--Javadoc)
7. [Импорты](#7-Импорты)
...
## 3. Расположение блоков, операторов, пробелы, скобки
