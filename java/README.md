...
* Длина строки не должна превышать 100 символов (в Android Studio в редакторе кода серая линия справа обозначает эту границу).
...
> Многое из описанного выше Android Studio умеет делать автоматически
> * Windows: `Ctrl + Alt + L`
...
> Всё описанное в этом пункте, Android Studio может сделать для вас автоматически с помощью комбинации клавиш:
> * Windows: `Ctrl + Alt + L`
> * Linux: `Ctrl + Shift + Alt + L`
> * macOS: `Option + Command + L`
...
> Как хорошо что вам не придется делать этого самостоятельно, Android Studio упорядочит их автоматически по сочетанию клавиш.
> * Windows: `Ctrl + Alt + L`
> * Linux: `Ctrl + Shift + Alt + L`
> * macOS: `Option + Command + L`
