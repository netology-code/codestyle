...
Имена процедур, функций и их параметров следует образовывать от терминов предметной области, чтобы из имени было понятно назначения. Именя должны документировать сами себя.
