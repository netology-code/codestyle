...
1. [Синтаксис](#1-Синтаксис).  
   1.1. [В конце строки должны стоять точка с запятой](#11-В-конце-строки-должна-стоять-точка-с-запятой).  
   ...
   1.4. [Всё пишется строчными буквами](#14-Все-пишется-строчными-буквами).  
